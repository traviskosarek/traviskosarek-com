...
export default class Server {
    ...
    private setApplicationCodePath() {
        this.server.use('/', express.static(path.join(Configuration.rootDirectory, '/')));
        this.server.use('/images', express.static(path.join(Configuration.rootDirectory, '/images')));
    }
